...
public class SU_AddDepartmentToEntity {
	...
	public static void main(String[] args) throws InterruptedException {
        ...
        wave.findElement(By.xpath("//*[@id=\"ngdialog1\"]/div[2]/div[1]/form/div[1]/input")).sendKeys("Finance"); 

        wave.findElement(By.xpath("//div/button[@class='btn btn-primary btn-labeled pull-right ng-binding']")).click();
